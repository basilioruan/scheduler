...
class StudentLevelControllerTests {
    ...
    void findById_shouldReturnResponseDTO() {
        ...
        BDDMockito.when(this.studentLevelInPort.findById(anyLong())).thenReturn(StudentLevelMocks.getStudentLevelResponseDTO());
    ...
    void findAll_shouldReturnResponseDTOList() {
        ...
        BDDMockito.when(this.studentLevelInPort.findAll()).thenReturn(List.of(StudentLevelMocks.getStudentLevelResponseDTO()));
    ...
    void save_shouldReturnNull() {
        StudentLevelResponseDTO actual = this.studentLevelController.save(StudentLevelMocks.getStudentLevelRequestDTO());
